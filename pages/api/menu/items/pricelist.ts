...
const getItemsForPricelist = async (req: NextApiRequest, res: NextApiResponse) => {
    try {
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
    if (req.method === "GET") {
        return authMiddleware(authorize([permissions.CAN_VIEW_ITEM])(getItemsForPricelist))(req, res);
    } else {
