...
const AddGroupItemModal = ({ isModalOpen, closeModal, selectedGroup, selectedGroupName, addItemToGroup }) => {
    ...
    const fetchModalItems = async (inputValue) => {
        ...
        try {
            ...
            const response = await fetch(`/api/menu/items?search=${encodeURIComponent(inputValue)}&excludeGrouped=${excludeGrouped}`, {
                headers: {
