...
export const supervisorRoutes: RouteEntry[] = sortRoutes([
  ...
  { pattern: "/supervisor/purchase-items", activeItem: "purchase-items", expandedMenuIds: ["suppliers"], breadcrumbs: [DS, SUPPLIERS_SUP, { label: "Purchase Config", path: "/supervisor/purchase-items" }] },
...
export const adminRoutes: RouteEntry[] = sortRoutes([
  ...
  { pattern: "/admin/purchase-items", activeItem: "purchase-items", expandedMenuIds: ["suppliers"], breadcrumbs: [DA, SUPPLIERS_ADM, { label: "Purchase Config", path: "/admin/purchase-items" }] },
...
export const cashierRoutes: RouteEntry[] = sortRoutes([
  ...
  { pattern: "/home/my-sales-report", activeItem: "my-sales-report", expandedMenuIds: [], breadcrumbs: [DC, { label: "Sales Report", path: "/home/my-sales-report" }] },
...
export const salesRoutes: RouteEntry[] = sortRoutes([
  ...
  { pattern: "/home/my-sales-report", activeItem: "my-sales-report", expandedMenuIds: [], breadcrumbs: [DH, { label: "Sales Report", path: "/home/my-sales-report" }] },
