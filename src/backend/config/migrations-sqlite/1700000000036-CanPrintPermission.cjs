...
const OriginalMigration = require("../migrations/1700000000036-CanPrintPermission.cjs");

module.exports = class CanPrintPermissionSqlite1700000000036 {
  name = "CanPrintPermissionSqlite1700000000036";
