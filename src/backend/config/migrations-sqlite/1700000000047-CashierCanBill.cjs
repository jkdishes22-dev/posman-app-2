...
const OriginalMigration = require("../migrations/1700000000047-CashierCanBill.cjs");

module.exports = class CashierCanBillSqlite1700000000047 {
  name = "CashierCanBillSqlite1700000000047";
