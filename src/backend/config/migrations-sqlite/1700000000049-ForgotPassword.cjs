...
const OriginalMigration = require("../migrations/1700000000049-ForgotPassword.cjs");

module.exports = class ForgotPasswordSqlite1700000000049 {
  name = "ForgotPasswordSqlite1700000000049";
