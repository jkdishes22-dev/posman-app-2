...
const OriginalMigration = require("../migrations/1700000000021-SeedReportPermissions.cjs");

module.exports = class SeedReportPermissionsSqlite1700000000021 {
  name = "SeedReportPermissionsSqlite1700000000021";
