...
const OriginalMigration = require("../migrations/1700000000046-SessionTimeoutSetting.cjs");

module.exports = class SessionTimeoutSettingSqlite1700000000046 {
  name = "SessionTimeoutSettingSqlite1700000000046";
