...
const OriginalMigration = require("../migrations/1700000000034-ExpensePermissions.cjs");

module.exports = class ExpensePermissionsSqlite1700000000034 {
  name = "ExpensePermissionsSqlite1700000000034";
