...
const productionCases = [
  ...
  { name: "POST /api/production/issues", method: "POST", handler: productionIssuesHandler, body: { item_id: 1, quantity: 1 }, wrong: () => salesToken, ok: () => storekeeperToken, forbiddenMode: "auth-gated" as const },
