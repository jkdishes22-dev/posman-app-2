...
import supplierTransactionsListHandler from "../../../pages/api/suppliers/transactions.js";
...
const supplierCases = [
  ...
  { name: "GET /api/suppliers/transactions", method: "GET", handler: supplierTransactionsListHandler, wrong: () => salesToken, ok: () => storekeeperToken },
];
